...
class EmpresaTest {
	...
	public void setUp() {
		this.sistema = new Empresa();           
                ...
                this.sistema.agregarNumeroGuia("2214444554");
		this.sistema.agregarNumeroGuia("2214444555");
		this.sistema.agregarNumeroGuia("2214444556");
		this.sistema.agregarNumeroGuia("2214444557");
		this.sistema.agregarNumeroGuia("2214444558");
		this.sistema.agregarNumeroGuia("2214444559");
	...
	void testAgregarUsuario() {
		...
		this.sistema.agregarNumeroGuia("2214444558"); 
                Cliente nuevaPersona = this.sistema.registrarUsuarioFisico("Alan Turing", "2444555");
